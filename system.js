...
const songsByArtist = {
    ...
    "Rizky Febian": [
        ...
        { title: "Kesempurnaan Cinta", audio: "Elemen/Lagu Rizky Febian/Kesempurnaan Cinta.mp3", image: "Elemen/Images Song/Kesempurnaan Cinta.jpeg" },
        { title: "Penantian Berharga", audio: "Elemen/Lagu Rizky Febian/Penantian Berharga.mp3", image: "Elemen/Images Song/Penantian Berharga.jpeg" },
        { title: "Cukup Tau", audio: "Elemen/Lagu Rizky Febian/Cukup Tau.mp3", image: "Elemen/Images Song/Cukup Tau.jpeg" },
    ],
    "Rex Orange County": [
        {}
    ],
    "Vierra": [
        { title: "Kesepian", audio: "Elemen/Lagu Vierra/Kesepian.mp3", image: "Elemen/Images Song/Kesepian.jpeg" },
    ],
};
...
function updateSongArtis(artistName) {
    ...
    songListContainer.querySelectorAll('.play-btn').forEach(btn => {
