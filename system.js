...
document.addEventListener('click', function(e) {
    if (e.target.closest('.link')) {
        ...
        if (navigator.share) {
            const artistImageUrl = artistImages[displayedArtist];
            if (artistImageUrl) {
                fetch(artistImageUrl)
                    ...
                    .then(() => {
                        console.log('Link berhasil dibagikan:', artistLink);
                    })
                    .catch(err => {
            ...
            // Fallback ke clipboard untuk browser yang tidak mendukung Web Share API
